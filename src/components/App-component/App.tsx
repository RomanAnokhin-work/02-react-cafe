...
import CafeInfo from "../CafeInfo-component/CafeInfo";
import VoteOption from "../VoteOptions-component/VoteOptions";
import VoteStats from "../VoteStats-component/VoteStats";
